...
(req,res) => {
    ...
    if(!errors.isEmpty()){
        ...
        return res.status(409).render('register',{'error': 'Complétez tous les champs avant de soumettre le formulaire.'});
    }
    ...
    User.findByMail(email, (users) => {
        if(users[0] == undefined) {
                ...
                res.redirect('/',{'succes':'Vous avez été correctement enregistré !'})
        }else{
